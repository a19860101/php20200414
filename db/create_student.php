            ...
            <div class="col-12">
                <form action="store_student.php" method="post">
                    ...
                    <div class="form-group">
                        <div>專長</div>
                        <div class="form-check form-check-inline">
                            <input type="checkbox" class="form-check-input" name="skills[]" id="graphic">
                            <label for="graphic" class="form-check-label">平面設計</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="checkbox" class="form-check-input" name="skills[]" id="web">
                            <label for="web" class="form-check-label">網頁設計</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input type="checkbox" class="form-check-input" name="skills[]" id="threeD">
